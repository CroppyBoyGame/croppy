function createUnityInstance(e, n, r) {
    function t(e, n, r) {
        if (u.startupErrorHandler) return void u.startupErrorHandler(e, n, r);
    ...
    function s(e, n) {
        if ("symbolsUrl" != e) {
            ...
            for (var e in u.downloadProgress) {
                ...
                i++, t.lengthComputable ? (o += t.loaded, s += t.total, a++) : t.finished || d++
            }
    ...
    function i(e) {
        return new Promise(function(n, r) {
            ...
            t.open("GET", u[e]), t.responseType = "arraybuffer", t.addEventListener("progress", function(n) {
                s(e, n)
            }), t.addEventListener("load", function(r) {
                s(e, r), n(new Uint8Array(t.response))
            }), t.send()
        })
    }
    ...
    return u.SystemInfo = function() {
        ...
        var g = t;
        switch (/Windows/.test(l) && (g = /Windows (.*)/.exec(l)[1], l = "Windows"), l) {
            case "Mac OS X":
            ...
            case "Android":
                ...
                break;
            case "iOS":
                g = /OS (\d+)_(\d+)_?(\d+)?/.exec(o), g = g[1] + "." + g[2] + "." + (0 | g[3])
        }
        return {
        ...
        u.SystemInfo.hasWebGL ? 1 == u.SystemInfo.hasWebGL ? n('Your browser does not support graphics API "WebGL 2.0" which is required for this content.') : u.SystemInfo.hasWasm ? (1 == u.SystemInfo.hasWebGL && u.print('Warning: Your browser does not support "WebGL 2.0" Graphics API, switching to "WebGL 1.0"'), u.startupErrorHandler = n, r(0), u.postRun.push(function() {
